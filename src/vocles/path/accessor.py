"""adapted from https://github.com/drivendataorg/pandas-path
under MIT license: https://github.com/drivendataorg/pandas-path/blob/master/LICENSE.txt
"""
...
from .array import is_path_dtype
...
class PathAccessor:
    ...
    @staticmethod
    def _validate(obj):
        if not is_path_dtype(obj):
            raise AttributeError(
                f"Cannot use 'path' accessor on objects of dtype '{obj.dtype}'.")
