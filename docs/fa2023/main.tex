...
Please know I am not suggesting there is anything wrong with this code per se; 
I have written code like this in myself in the past.
My goal is to illustrate how such code can be easier to both write and read.
