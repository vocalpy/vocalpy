...
def test_default_spect_fname_func(specific_audio_dir, audio_format):
    ...
    for audio_path in audio_paths:
        spect_path = vocalpy.domain_model.services.spectrogram_maker.default_spect_fname_func(audio_path)
...
def test_spect_maker_audio_paths(specific_audio_dir, audio_format, output_dir, tmp_path):
    audio_dir = specific_audio_dir(audio_format)
